...
ActiveRecord::Schema.define(version: 20170828130459) do
  ...
  create_table "enterprises", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.text     "nickname_suffix",   limit: 65535
    t.text     "description",       limit: 65535
    t.text     "headquarters",      limit: 65535
    t.date     "founded"
    t.text     "website",           limit: 65535
    t.text     "avatar",            limit: 65535
    t.text     "icon",              limit: 65535
    t.text     "avatar_operator",   limit: 65535
    t.text     "avatar_supervisor", limit: 65535
    t.datetime "created_at",                      null: false
    t.datetime "updated_at",                      null: false
  end
